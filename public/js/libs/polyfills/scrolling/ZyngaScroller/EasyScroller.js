...
document.addEventListener("DOMContentLoaded", function() {	
	var //elements = document.querySelectorAll('[data-scrollable],[data-zoomable]'), 
		els = document.querySelectorAll('[data-scrollable],[data-zoomable]'),
		//element;
		el; 

	//for (var i = 0; i < elements.length; i++) {
	for (var i = 0, lim = els.length; i< lim; i++) {

		//element = elements[i];
		el = els[i]
 	
		var scrollable = el.dataset.scrollable;
		var zoomable = el.dataset.zoomable || '';	
		var scrollable = el.attributes.getNamedItem('data-scrollable') ? el.attributes.getNamedItem('data-scrollable').value : null;	
		var zoomable = el.attributes.getNamedItem('data-zoomable') ? el.attributes.getNamedItem('data-zoomable').value : '';
